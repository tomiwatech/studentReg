...
if (isset($_POST['fullname']) && isset($_POST['matric'])) {
   if (isset($_POST['entry']) && isset($_POST['email'])) {
       if (isset($_POST['programme']) && isset($_POST['sex'])) {
           if (isset($_POST['phone']) && isset($_POST['dob'])) {
                if (isset($_POST['pob']) && isset($_POST['address']))  {
...
$query = "INSERT INTO biodata(fullname,matric,programme,entry,sex,email,phone,pob,address,dob) VALUES('$fullname','$matric','$programme','$entry','$sex','$email','$phone','$pob','$address','$dob')";
$query_run = @mysql_query($query);


                  header('Location:allbio.php');
...
<head>
  ...
  <body class="layout layout-header-fixed" style="font-family:consolas">
    ...
    <h5 style="color:#0ac29d;text-align: center"> BIODATA OF STUDENT</h3>

<form class="form-horizontal" role="form" style="width: 80%;color: #0ac29d" method="post" action="bio.php">
                                <div class="form-body">
                ...
                <input type="text" name="fullname" class="form-control" placeholder="Enter Full Name" required> </div>
                      ...
                      <input type="text" name="matric" class="form-control" placeholder="Enter Matric" required> </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Entry Year</label>
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <span class="input-group-addon">
                                                    <i class="fa fa-envelope"></i>
                                                </span>
                     <input type="text" name="entry" class="form-control" placeholder="Enter Entry Year" required> </div>
                                        </div>
                                    </div>
              ...
              <button type="submit" style="background: #0ac29d;color: white;width: 100px;margin-right: 17pc;margin-top: 5px" class="btn green" >Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
