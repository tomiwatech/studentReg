...
if (isset($_POST['course']) && isset($_POST['code'])) {
   if (isset($_POST['unit'])) {
     ...
     $unit = $_POST['unit'];
      ...
      $query = "INSERT INTO course(course,code,unit,matric) VALUES('$course','$code','$unit','$matric')";

     if ($query_run = mysql_query($query)) {
       $successMsg = "New record has been added";
     }else{
        $errorMsg = "Error inserting record. You might need to fill the biodata form";
     }
...
<marquee behavior="alternate"><h5 style="color:#0ac29d;"> COURSE REGISTRATION</h5></marquee>
                 ...
                 <form method="post" action="course.php">
                   ...
                   <td>
                                    <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                          <input type="text" name="course" class="form-control" placeholder="Enter course name" required> </div>
                                            </div>
                        </td>
                        <td>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                          <input type="text" name="code" class="form-control" placeholder="Enter course code" required> </div>
                                            </div>
                        </td>
                        ...
                        <td>         
                             <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                          <input type="text" name="unit" class="form-control" placeholder="Enter course unit" required> </div>
                                            </div>
                          </td>

                          <td>
<button type="submit" style="background: #0ac29d;color: white;width: 100px;" class="btn green" >Add Course</button>
                          </td>
                  </form>
                      </tr>

                     <?php 
                     $sql = "SELECT * FROM course WHERE matric = '$matric'";
...
<td><a type="button" href="course.php?delete=<?php echo $row['id']?>" style="background:#ec4657;border-color:#ec4657;color: white;width: 100px;" class="btn" onclick="return confirm('Are you sure you want to delete this record?')">Delete</a></td>
                    </tr>
...
<a type="submit" href="allcourses.php" onclick="return confirm('Are you sure you want to submit theses courses')" style="background:#0ac29d;color:white;width:100px;float: right;margin-right:15px;margin-top:5px" name="btn" class="btn" >SUBMIT</a>
                </div>
              </div>
            </div>
          </div>
