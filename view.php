...
require 'connect.php';  
    ...
    $resource = "SELECT * FROM  biodata ORDER BY matric";
    $resource_query= mysql_query($resource);

while($row = mysql_fetch_array($resource_query)):;
                 $column1 = $row['1'];
                 $column2 = $row['2'];
    endwhile;
            ...
            <div class="col-xs-12">
              <div class="card">
                <div class="card-header">
                  <strong style="color:#0ac29d;text-align:center;">MATRIC : <?php echo $matric ?></strong>
...
<h5 style="color:#0ac29d;text-align: center"> DATATABLE OF REGISTERED STUDENTS</h5>

  <div class="row gutter-xs" style="width:80%;margin-left: 8pc">
            <div class="col-xs-12">
              <div class="card">
                <div class="card-header" style="text-align:center">
                  <strong style="color:#0ac29d;;">ALL REGISTERED STUDENTS</strong>
                </div>
  ...
  <table id="demo-datatables-1" class="table table-striped table-hover table-nowrap dataTable"  cellspacing="0" width="100%">
                    <thead style="color:#0ac29d">
                      <tr>
                        ...
                        <th style="text-align: center">MATRIC</th>
                        <th style="text-align: center">VIEW REGISTERED COURSES</th>
                    ...
                    <tbody style="text-align: center;color: grey">
                     ...
                     <tr></tr>
                      <tr>
                        <td><?php echo $row['1']?></td>
                        <td><?php echo $row['2']?></td>
      <td><a href="?matric=<?php echo $row['2']?>" on-click="fetch()" style="text-decoration: none">View</a></td>
                      </tr>
